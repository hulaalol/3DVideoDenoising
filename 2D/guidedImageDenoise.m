...
function guidedImageDenoise(path, imageSet)

folderTest    = 'data';
saveResult = true;
folderResultCur       =  fullfile(path, ['results\guidedImage_',imageSet,'_',datestr(now,'mm_dd_HH-MM-SS')]);
